...
export function registerResources(server: McpServer) {
  server.resource(
    ...
    { description: "Full Prisma database schema with all models, fields, and relations", mimeType: "text/plain" },
    async () => {
  ...
  server.resource(
    "shared-types",
    "fxflow://schema/types",
    { description: "All shared TypeScript type definitions (packages/types/src/index.ts)", mimeType: "text/plain" },
    async () => {
  ...
  server.resource(
    ...
    async () => {
      try {
        ...
        return { contents: [{ uri: "fxflow://config/structure", text: doc, mimeType: "text/markdown" }] }
      } catch {
        return { contents: [{ uri: "fxflow://config/structure", text: "Directory structure doc not found", mimeType: "text/plain" }] }
      }
    }
  )
}
