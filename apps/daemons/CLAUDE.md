...
- **Soft Tier 1 filters**: All filters are soft penalties, not hard gates. HTF trend disagreement: −8 confidence. Secondary RSI overextension: −8 to −15. Low volatility (BB squeeze): −10. Minimum 2 directional reasons required. Confluence minimum: 15 points (after penalties).
