 ...
 * ADR:  #0002 — failed open before scripts/sync-ide-rules.mjs existed;
 *       the generator shipped in Sub-phase 7, so this hook now enforces.
 *
...
async function main() {
  ...
  if (!fs.existsSync(path.join(repoRoot, "scripts/sync-ide-rules.mjs")))
    return allow();
